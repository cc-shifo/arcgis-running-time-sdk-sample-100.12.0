...
public class MainActivity extends AppCompatActivity {
  ...
  private void addBuoyPoints(GraphicsOverlay graphicOverlay) {
    ...
    Point buoy5Loc = new Point(-2.6395150461199726, 56.06128916736989, wgs84);
    ...
    SimpleMarkerSymbol buoyMarker5 = new SimpleMarkerSymbol(SimpleMarkerSymbol.Style.CIRCLE,
            Color.BLUE, 10);
    Graphic buoyGraphic5 = new Graphic(buoy5Loc, buoyMarker5);
    graphicOverlay.getGraphics().add(buoyGraphic5);
  }
