...
public class CGS2000Image {
    //天地图官网申请key
    public static final String key = "4a94b0e404cc8594b74e2be321c62983";


    private static final List<String> SubDomain =
            Arrays.asList("t0", "t1", "t2", "t3", "t4", "t5", "t6", "t7");
    private static final String URL_VECTOR_2000 =
            "http://{subDomain}.tianditu.com/DataServer?T=vec_c&x={col}&y={row}&l={level}&tk=" + key;
    private static final String URL_VECTOR_ANNOTATION_CHINESE_2000 =
            "http://{subDomain}.tianditu.com/DataServer?T=cva_c&x={col}&y={row}&l={level}&tk=" + key;
    private static final String URL_VECTOR_ANNOTATION_ENGLISH_2000 =
            "http://{subDomain}.tianditu.com/DataServer?T=eva_c&x={col}&y={row}&l={level}&tk=" + key;
    private static final String URL_IMAGE_2000 =
            "http://{subDomain}.tianditu.com/DataServer?T=img_c&x={col}&y={row}&l={level}&tk=" + key;
    private static final String URL_IMAGE_ANNOTATION_CHINESE_2000 =
            "http://{subDomain}.tianditu.com/DataServer?T=cia_c&x={col}&y={row}&l={level}&tk=" + key;
    private static final String URL_IMAGE_ANNOTATION_ENGLISH_2000 =
            "http://{subDomain}.tianditu.com/DataServer?T=eia_c&x={col}&y={row}&l={level}&tk=" + key;
    private static final String URL_TERRAIN_2000 =
            "http://{subDomain}.tianditu.com/DataServer?T=ter_c&x={col}&y={row}&l={level}&tk=" + key;
    private static final String URL_TERRAIN_ANNOTATION_CHINESE_2000 =
            "http://{subDomain}.tianditu.com/DataServer?T=cta_c&x={col}&y={row}&l={level}&tk=" + key;

    private static final String URL_VECTOR_MERCATOR =
            "http://{subDomain}.tianditu.com/DataServer?T=vec_w&x={col}&y={row}&l={level}&tk=" + key;
    private static final String URL_VECTOR_ANNOTATION_CHINESE_MERCATOR =
            "http://{subDomain}.tianditu.com/DataServer?T=cva_w&x={col}&y={row}&l={level}&tk=" + key;
    private static final String URL_VECTOR_ANNOTATION_ENGLISH_MERCATOR =
            "http://{subDomain}.tianditu.com/DataServer?T=eva_w&x={col}&y={row}&l={level}&tk=" + key;
    private static final String URL_IMAGE_MERCATOR =
            "http://{subDomain}.tianditu.com/DataServer?T=img_w&x={col}&y={row}&l={level}&tk=" + key;
    private static final String URL_IMAGE_ANNOTATION_CHINESE_MERCATOR =
            "http://{subDomain}.tianditu.com/DataServer?T=cia_w&x={col}&y={row}&l={level}&tk=" + key;
    private static final String URL_IMAGE_ANNOTATION_ENGLISH_MERCATOR =
            "http://{subDomain}.tianditu.com/DataServer?T=eia_w&x={col}&y={row}&l={level}&tk=" + key;
    private static final String URL_TERRAIN_MERCATOR =
            "http://{subDomain}.tianditu.com/DataServer?T=ter_w&x={col}&y={row}&l={level}&tk=" + key;
    private static final String URL_TERRAIN_ANNOTATION_CHINESE_MERCATOR =
            "http://{subDomain}.tianditu.com/DataServer?T=cta_w&x={col}&y={row}&l={level}&tk=" + key;
    //http://114.116.200.186:8091/mapserver/label/7790b8e15ef6400ea086ddb94febd9ff/getDatas?x=3407
// &y=709&l=13&styleId=_default__&tilesize=512&clientVersion=jssdk_bate@%20leaflet%202.2.6
//    public static final String URL_YANJIUYAN_VMAP =
//            "http://114.116.200.186:8091/mapserver/vmap/7790b8e15ef6400ea086ddb94febd9ff/getMAP?x={col}&y={row}&l={level}&styleId=_default__&ratio=2&tilesize=256";

//    public static String URL_YANJIUYAN_VMAP;

//    static {
//        URL_YANJIUYAN_VMAP = "http://10.1.3.97:9886/tdt/vec_c/{level}/{col}/{row}.png";
//    }
    ...
    private static final Envelope ENVELOPE_2000 =
            new Envelope(X_MIN_2000, Y_MIN_2000, X_MAX_2000, Y_MAX_2000, SRID_2000);
    private static final Envelope ENVELOPE_MERCATOR =
            new Envelope(X_MIN_MERCATOR, Y_MIN_MERCATOR, X_MAX_MERCATOR, Y_MAX_MERCATOR, SRID_MERCATOR);
    ...
    private static final double[] SCALES = {
            ...
            4513.997733376551, 2256.998866688275, 1128.4994333441375
    };
    ...
    public static WebTiledLayer CreateTianDiTuTiledLayer(LayerType layerType) {
        ...
        try {
            ...
            Point mainOrigin;
            if (mainIs2000) {
//                if (layerType.equals(LayerType.YANJIUYUAN_VMAP_2000)) {
//                    for (int i = 16; i <= maxZoomLevel; i++) {
//                        LevelOfDetail item =
...
//                }
            ...
            mainTileInfo =
                    new TileInfo(DPI, TileInfo.ImageFormat.PNG24, mainLevelOfDetail, mainOrigin,
                            mainOrigin.getSpatialReference(), tileHeight, tileWidth);
            webTiledLayer = new WebTiledLayer(mainUrl, SubDomain, mainTileInfo, mainEnvelope);
    ...
    protected static LayerType getTianDiTuLayerType(String layerType) {
        ...
        switch (layerType) {
            ...
            case "TIANDITU_TERRAIN_ANNOTATION_CHINESE_2000":
                ...
                break;
            case "YANJIUYUAN_VMAP_2000":
                result = LayerType.YANJIUYUAN_VMAP_2000;
                break;
            case "YANJIUYUAN_VMAP_2000_MANAGER":
                result = LayerType.YANJIUYUAN_VMAP_2000_MANAGER;
                break;
        }
        return result;
    }
    ...
    public enum LayerType {
         ...
         * 研究院地图瓦片服务
         */
        YANJIUYUAN_VMAP_2000,
        /**
         * 研究院地图瓦片服务
         */
        YANJIUYUAN_VMAP_2000_MANAGER,
