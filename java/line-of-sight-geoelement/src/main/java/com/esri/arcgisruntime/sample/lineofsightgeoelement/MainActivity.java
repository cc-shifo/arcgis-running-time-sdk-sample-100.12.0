...
public class MainActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    BitmapDrawable drawable = (BitmapDrawable) ContextCompat.getDrawable(
            mSceneView.getContext(), R.drawable.icon_airplane);
    PictureMarkerSymbol pictureMarkerSymbol;
    try {
      pictureMarkerSymbol= PictureMarkerSymbol.createAsync(drawable).get();
    ...
    mTaxiGraphic = new Graphic(mWaypoints.get(0), pictureMarkerSymbol);
